...
🔹 [Introdução às funções iterantes]() | 🔹 [Crie tabelas de parâmetros]() | 🔹 [Como criar medidas dinâmicas]() | 🔹 [Calcule o ano anterior com a SAMEPERIODLASTYEAR]() | 🔹 [Calcule o mês anterior com DATEADD]() | 🔹 [Acumule valores com funções de TOTALYDT, QTD, e MTD]()  
